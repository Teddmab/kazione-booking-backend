-- 036_calendar_staff_color.sql
-- Add calendar_color to get_business_calendar so the owner calendar can
-- colour each event by staff member instead of a generic status colour.
