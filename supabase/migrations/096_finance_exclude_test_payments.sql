-- 096_finance_exclude_test_payments.sql
--
-- Patches all five finance functions so that:
--   • Payments with is_test = true are excluded from revenue calculations.
--   • Soft-deleted appointments (deleted_at IS NOT NULL) are excluded from
--     all appointment-based aggregations (staff performance, dashboard KPIs).
--
-- These two conditions together ensure that deleting a completed appointment
-- (optionally marking its payment as a test transaction) cleanly removes the
-- record from all reports without destroying the audit trail.

-- ─────────────────────────────────────────────────────────────────────────────
-- 1) get_revenue_summary  — exclude is_test payments
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2) get_income_breakdown  — exclude is_test payments
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 3) get_tax_summary  — exclude is_test payments
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5) get_owner_dashboard_kpis  — exclude soft-deleted appointments
-- ─────────────────────────────────────────────────────────────────────────────
